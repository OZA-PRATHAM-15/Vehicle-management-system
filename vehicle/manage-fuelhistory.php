					...
					<div class="row">
						<div class="col-md-12">
							...
							<div class="panel panel-default">
								<div class="panel-heading">Fuel Details</div>
									...
									<table id="zctb" class="display table table-striped table-bordered table-hover"
										...
										<thead>
											<tr>
												...
												<th>Rate/L.</th>
												<th>Fuel Type</th>
												<th>Average of Vehicle</th>
												<th>Total Amount Of Fuel</th>
												<th>Action</th>
											</tr>
										</thead>
										<tbody>

											<?php $sql = "SELECT * from tblfuel";
											$query = $dbh->prepare($sql);
											$query->execute();
											...
											if ($query->rowCount() > 0) {
												foreach ($results as $result) { ?>
													<tr>
														...
														<td>
															<?php echo htmlentities($result->vehicle_no); ?>
														</td>
														<td>
															<?php echo htmlentities($result->rate); ?>
														</td>
														<td>
															<?php echo htmlentities($result->fuel_type); ?>
														</td>
														<td>
															<?php echo htmlentities($result->average_of_vehicle); ?>
														</td>
														<td>
															<?php echo htmlentities($result->total_amount_of_fuel); ?>
														</td>
